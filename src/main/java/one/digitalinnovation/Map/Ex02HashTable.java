...
// 02 [ok] - Remover o estado de Minas Gerais
        System.out.println("Remover o estado de Minas Gerais: " + estadosBrasil.remove("MG"));
...
// 04 [ok] - Verificar o tamanho do mapa
        System.out.println("Verificar o tamanho do mapa: " + estadosBrasil.size() + " elementos");
...
// 06 [ok] - Navegar em todos os registros do mapa, mostrando no console o seguinte formato: NOME (SIGLA)
        System.out.println("Navegar em todos os registros do mapa, mostrando no console o seguinte formato: NOME (SIGLA)");
        for (String key : estadosBrasil.keySet()) {
            System.out.println("Nome: " + estadosBrasil.get(key) + " - Sigla: " + key);
        }
...
// 08 [ok] - Verificar se o estado do Maranhão existe no map buscando por seu nome
        System.out.println("Verificar se o estado do Maranhão existe no map buscando por seu nome: " + estadosBrasil.containsValue("Maranhão"));
    }
}
