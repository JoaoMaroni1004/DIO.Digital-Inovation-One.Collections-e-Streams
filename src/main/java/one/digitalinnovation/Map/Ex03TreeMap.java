...
// 06 [] - Navegar em todos os registros do mapa, mostrando no console o seguinte formato: NOME (SIGLA)
        Iterator<String> iterator = estadosBrasil.keySet().iterator();
        while (iterator.hasNext()){
            String chave = iterator.next();
            System.out.println("Nome: " + estadosBrasil.get(chave) + " Sigla: " + chave);
        }
// 07 [] - Verificar se o estado de Santa Catarina existe no mapa buscando por sua sigla
